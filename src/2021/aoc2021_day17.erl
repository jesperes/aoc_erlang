...
solve(Target) ->
    ...
    % The range here is tweaked so that it is the smallest number of velocities
    % we need to check without getting the wrong result.
    Hits = try_fire_probe(Target, 8, 73, -248, 248),
