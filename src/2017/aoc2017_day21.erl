...
apply_rule_test() ->
    Rules = parse(<<"../.# => ##./#../...\n.#./..#/### => #..#/..../..../#..#">>),
    ?assertEqual([<<"#..#">>, <<"....">>, <<"....">>, <<"#..#">>],
                 apply_rule(start_pattern(), Rules)).

split_binary_2_test() ->
    ?assertEqual([<<1, 2>>, <<3, 4>>], split_binary_2(<<1, 2, 3, 4>>)).
...
split_test() ->
    ...
    Image3 = [<<"..">>, <<"#.">>],
    Image4 = [<<"..">>, <<".#">>],
    Expected = [Image1, Image2, Image3, Image4],
    ?assertEqual(Expected, split(Image)).
...
split3_test() ->
    ...
    Image8 = [<<"..">>, <<"##">>],
    Image9 = [<<".#">>, <<"##">>],
    Expected = [Image1, Image2, Image3, Image4, Image5, Image6, Image7, Image8, Image9],
    ?assertEqual(Expected, split(Image)).
