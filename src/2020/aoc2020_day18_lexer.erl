...
-module(aoc2020_day18_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/home/jespereskilson/dev/aoc_erlang/src/2020/aoc2020_day18_lexer.xrl", 23).
...
-file("/home/jespereskilson/dev/aoc_erlang/src/2020/aoc2020_day18_lexer.erl", 309).
yystate() -> 5.

yystate(6, [10|Ics], Line, Tlen, _, _) ->
    yystate(6, Ics, Line+1, Tlen+1, 0, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(6, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 32 ->
    yystate(6, Ics, Line, Tlen+1, 0, Tlen);
...
-file("/home/jespereskilson/dev/aoc_erlang/src/2020/aoc2020_day18_lexer.xrl", 4).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/1}).
-file("/home/jespereskilson/dev/aoc_erlang/src/2020/aoc2020_day18_lexer.xrl", 7).
yyaction_1(TokenLine) ->
     { token, { mult_op, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("/home/jespereskilson/dev/aoc_erlang/src/2020/aoc2020_day18_lexer.xrl", 10).
yyaction_2(TokenLine) ->
     { token, { plus_op, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("/home/jespereskilson/dev/aoc_erlang/src/2020/aoc2020_day18_lexer.xrl", 13).
yyaction_3(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("/home/jespereskilson/dev/aoc_erlang/src/2020/aoc2020_day18_lexer.xrl", 16).
yyaction_4(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("/home/jespereskilson/dev/aoc_erlang/src/2020/aoc2020_day18_lexer.xrl", 19).
yyaction_5(TokenChars) ->
